...
class OrderService {
     ...
     * CartItem
     *   ↓
     * reivindica atomicamente o Cart
     *   ↓
     * valida estoque
     *   ↓
     * baixa estoque
     ...
     * Delivery
     *
     * O Cart é marcado como checked_out antes
     * dos efeitos comerciais do checkout.
     *
     * Como tudo ocorre dentro da mesma transação,
     * qualquer erro posterior desfaz também
     * essa alteração.
     */
    async checkoutCart({
        tenantId,
        ...
        const result =
            await prisma.$transaction(
                async tx => {
                    ...
                    /*
                     * Reivindica atomicamente o carrinho.
                     *
                     * Apenas uma transação concorrente pode
                     * alterar este carrinho de active para
                     * checked_out.
                     *
                     * Se outra transação já tiver finalizado
                     * ou estiver finalizando o mesmo carrinho,
                     * count será 0 e este checkout será abortado
                     * antes de baixar estoque ou criar Order.
                     *
                     * Como esta alteração ocorre dentro da mesma
                     * transação do checkout, qualquer erro
                     * posterior provoca rollback e o carrinho
                     * volta a permanecer active.
                     */
                    const claimedCart =
                    ...
                    if (
                        ...
                        throw new Error(
                            "Este carrinho já foi finalizado ou está sendo processado."
                        );
                    ...
                    /*
                     * O carrinho já foi reivindicado
                     * atomicamente como checked_out
                     * antes da baixa de estoque e da
                     * criação do pedido.
                     *
                     * Não fazemos um segundo update aqui.
                     */
                    return {
